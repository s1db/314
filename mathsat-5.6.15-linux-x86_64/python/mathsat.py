...
def _msat_is_simple_type(env, tp, out_name):
    r"""_msat_is_simple_type(msat_env env, msat_type tp, char ** out_name) -> int"""
    return _mathsat._msat_is_simple_type(env, tp, out_name)

def _msat_is_function_type(env, tp, out_num_params, out_param_types, out_return_type):
    r"""_msat_is_function_type(msat_env env, msat_type tp, size_t * out_num_params, msat_type ** out_param_types, msat_type out_return_type) -> int"""
    return _mathsat._msat_is_function_type(env, tp, out_num_params, out_param_types, out_return_type)
...
def _msat_all_sat_ext(e, important, num_important, phase, func):
    r"""_msat_all_sat_ext(msat_env e, msat_term important, size_t num_important, msat_truth_value phase, msat_all_sat_model_callback func) -> int"""
    return _mathsat._msat_all_sat_ext(e, important, num_important, phase, func)
