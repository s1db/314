...
public class api {
    ...
    public static String msat_is_simple_type(long e, long tp) {
        return msat_is_simple_type(e, tp, 0);
    }

    public static long[] msat_is_function_type(long e, long tp) {
        return msat_is_function_type(e, tp, 0, 0, 0);
    }
    ...
    public static int msat_all_sat_ext(long e, long[] important, int phase,
                                       AllSatModelCallback func) {
        return msat_all_sat_ext(e, important, important.length, phase, func, 0);
    }
    ...
    public static native String msat_is_simple_type(long env, long tp, int out_name);
    public static native long[] msat_is_function_type(long env, long tp, int out_num_params, int out_param_types, int out_return_type);
    ...
    public static native int msat_all_sat_ext(long e, long[] important, int num_important, int phase, AllSatModelCallback func, int user_data);
