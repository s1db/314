...
#undef mathsat_api_MSAT_TAG_FP_TO_SBV
#define mathsat_api_MSAT_TAG_FP_TO_SBV 59L
#undef mathsat_api_MSAT_TAG_FP_TO_UBV
#define mathsat_api_MSAT_TAG_FP_TO_UBV 60L
#undef mathsat_api_MSAT_TAG_FP_AS_IEEEBV
#define mathsat_api_MSAT_TAG_FP_AS_IEEEBV 61L
#undef mathsat_api_MSAT_TAG_FP_ISNAN
#define mathsat_api_MSAT_TAG_FP_ISNAN 62L
#undef mathsat_api_MSAT_TAG_FP_ISINF
#define mathsat_api_MSAT_TAG_FP_ISINF 63L
#undef mathsat_api_MSAT_TAG_FP_ISZERO
#define mathsat_api_MSAT_TAG_FP_ISZERO 64L
#undef mathsat_api_MSAT_TAG_FP_ISSUBNORMAL
#define mathsat_api_MSAT_TAG_FP_ISSUBNORMAL 65L
#undef mathsat_api_MSAT_TAG_FP_ISNORMAL
#define mathsat_api_MSAT_TAG_FP_ISNORMAL 66L
#undef mathsat_api_MSAT_TAG_FP_ISNEG
#define mathsat_api_MSAT_TAG_FP_ISNEG 67L
#undef mathsat_api_MSAT_TAG_FP_ISPOS
#define mathsat_api_MSAT_TAG_FP_ISPOS 68L
#undef mathsat_api_MSAT_TAG_FP_FROM_IEEEBV
#define mathsat_api_MSAT_TAG_FP_FROM_IEEEBV 69L
#undef mathsat_api_MSAT_TAG_INT_FROM_UBV
#define mathsat_api_MSAT_TAG_INT_FROM_UBV 70L
#undef mathsat_api_MSAT_TAG_INT_FROM_SBV
#define mathsat_api_MSAT_TAG_INT_FROM_SBV 71L
#undef mathsat_api_MSAT_TAG_INT_TO_BV
#define mathsat_api_MSAT_TAG_INT_TO_BV 72L
#undef mathsat_api_MSAT_TAG_PI
#define mathsat_api_MSAT_TAG_PI 73L
#undef mathsat_api_MSAT_TAG_EXP
#define mathsat_api_MSAT_TAG_EXP 74L
#undef mathsat_api_MSAT_TAG_SIN
#define mathsat_api_MSAT_TAG_SIN 75L
#undef mathsat_api_MSAT_TAG_LOG
#define mathsat_api_MSAT_TAG_LOG 76L
#undef mathsat_api_MSAT_TAG_POW
#define mathsat_api_MSAT_TAG_POW 77L
#undef mathsat_api_MSAT_TAG_ASIN
#define mathsat_api_MSAT_TAG_ASIN 78L
#undef mathsat_api_MSAT_TAG_FORALL
#define mathsat_api_MSAT_TAG_FORALL 79L
#undef mathsat_api_MSAT_TAG_EXISTS
#define mathsat_api_MSAT_TAG_EXISTS 80L
...
/*
 * Class:     mathsat_api
 * Method:    msat_get_version_id
 * Signature: ()Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_mathsat_api_msat_1get_1version_1id
  (JNIEnv *, jclass);
...
/*
 * Class:     mathsat_api
 * Method:    msat_get_enum_type
 * Signature: (JLjava/lang/String;I[Ljava/lang/String;)J
 */
JNIEXPORT jlong JNICALL Java_mathsat_api_msat_1get_1enum_1type
...
/*
 * Class:     mathsat_api
 * Method:    msat_is_enum_type
 * Signature: (JJII)[J
 */
JNIEXPORT jlongArray JNICALL Java_mathsat_api_msat_1is_1enum_1type
  (JNIEnv *, jclass, jlong, jlong, jint, jint);

/*
 * Class:     mathsat_api
 * Method:    msat_is_simple_type
 * Signature: (JJI)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_mathsat_api_msat_1is_1simple_1type
  (JNIEnv *, jclass, jlong, jlong, jint);

/*
 * Class:     mathsat_api
 * Method:    msat_is_function_type
 * Signature: (JJIII)[J
 */
JNIEXPORT jlongArray JNICALL Java_mathsat_api_msat_1is_1function_1type
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_mathsat_api_msat_1type_1id
  (JNIEnv *, jclass, jlong);
...
/*
 * Class:     mathsat_api
 * Method:    msat_make_fp_to_sbv
 * Signature: (JIJJ)J
 */
JNIEXPORT jlong JNICALL Java_mathsat_api_msat_1make_1fp_1to_1sbv
...
/*
 * Class:     mathsat_api
 * Method:    msat_make_fp_to_ubv
 * Signature: (JIJJ)J
 */
JNIEXPORT jlong JNICALL Java_mathsat_api_msat_1make_1fp_1to_1ubv
  (JNIEnv *, jclass, jlong, jint, jlong, jlong);
...
/*
 * Class:     mathsat_api
 * Method:    msat_term_is_enum_value
 * Signature: (JJ)I
 */
JNIEXPORT jint JNICALL Java_mathsat_api_msat_1term_1is_1enum_1value
  (JNIEnv *, jclass, jlong, jlong);
...
/*
 * Class:     mathsat_api
 * Method:    msat_term_is_fp_to_sbv
 * Signature: (JJ)I
 */
JNIEXPORT jint JNICALL Java_mathsat_api_msat_1term_1is_1fp_1to_1sbv
  (JNIEnv *, jclass, jlong, jlong);
...
/*
 * Class:     mathsat_api
 * Method:    msat_term_is_fp_to_ubv
 * Signature: (JJ)I
 */
JNIEXPORT jint JNICALL Java_mathsat_api_msat_1term_1is_1fp_1to_1ubv
  (JNIEnv *, jclass, jlong, jlong);
...
/*
 * Class:     mathsat_api
 * Method:    msat_all_sat_ext
 * Signature: (J[JIILmathsat/AllSatModelCallback;I)I
 */
JNIEXPORT jint JNICALL Java_mathsat_api_msat_1all_1sat_1ext
  (JNIEnv *, jclass, jlong, jlongArray, jint, jint, jobject, jint);
