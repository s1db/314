"""Tests for ManthanUniquePreprocessor (uniquely defined function detection)."""

import pytest
from src.preprocessing.manthan_unique import ManthanUniquePreprocessor
...
@pytest.fixture
def preprocessor() -> ManthanUniquePreprocessor:
    return ManthanUniquePreprocessor()
...
class TestUniquelyDefined:
    ...
    def test_y_equals_x(
        self, preprocessor: ManthanUniquePreprocessor, fm: FunctionManager
    ) -> None:
